...
import { Loader2, Plus, Sparkles, ChevronDown, ChevronUp, Info } from "lucide-react";
...
import { RecipeVariantInput } from "../../app/(recipes-management)/recipes-management/_components/recipe-variant-input";
