...
import { CustomerItem, ApiResponse, OrderItem, AnalyticsData, ChartDataPoint, GrowthDataPoint, OrderTypeData, ComparisonData, SegmentData } from '@/lib/types/analytics';
