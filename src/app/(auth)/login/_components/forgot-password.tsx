  ...
  return (
    <div
      className={`absolute inset-0 bg-white rounded-t-2xl sm:rounded-sm flex flex-col justify-center px-6 sm:px-12 md:px-16 pb-8 sm:pb-40 z-10 transition-transform duration-700 sm:duration-1000 ease-out ${
        showForgotContainer ? "transform translate-y-0" : "transform translate-y-full"
      }`}
      style={{ willChange: "transform", fontFamily: "Manrope, system-ui, sans-serif" }}
    >
      <div className="mb-6 sm:mb-12 text-center mt-0 sm:-mt-8">
      ...
      <div className="space-y-4 sm:space-y-5">
        <div className="relative">
          <Input
            ...
            disabled={isLoading}
            className="placeholder-gray-400 text-sm tracking-wide rounded-sm h-12 sm:h-14 pl-12"
          />
        ...
        <div className="pt-2 sm:pt-4">
          <Button
            type="button"
            size="lg"
            className="h-12 sm:h-14 w-full bg-black text-[#d1ab35] hover:bg-gray-800 font-semibold tracking-widest rounded-sm text-xs sm:text-sm"
            disabled={isLoading}
